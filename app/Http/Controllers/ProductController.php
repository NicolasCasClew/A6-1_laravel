...
class ProductController extends Controller
{
    ...
    public function products()
    {
        $products = [
            ...
            ["id" => 75, "nombre" => "Asdisdas", "desc" => "Ole pa jugar al furbo viva el Beti", "imgUrl" => "/img/shoe.png", "precio" => 12],
    ...
    {
        $viewData["title"] = "$id - Tienda Online";
        $viewData["AAAAAAAAAAAAAAAAAA"] = "AAAAAAAAAAAAAAAAAAAAAAAAAAAA";
